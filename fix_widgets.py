...
files_to_update = [
    r'c:\Users\USER\AndroidStudioProjects\ilaba-app\lib\widgets\custom_button.dart',
    r'c:\Users\USER\AndroidStudioProjects\ilaba-app\lib\widgets\custom_text_field.dart',
    r'c:\Users\USER\AndroidStudioProjects\ilaba-app\lib\widgets\notification_bell_widget.dart',
]

replacements = [
    # Colors.white -> ILabaColors.white
    (r'\bColors\.white\b', 'ILabaColors.white'),
    # Colors.black -> ILabaColors.darkText
...
print(f"Updating {len(files_to_update)} widget files\n")
...
for file_path in files_to_update:
    ...
    print(f"Processing {file_path.split(chr(92))[-1]}...", end=' ')
...
print(f"\n✓ Successfully updated {updated_count} widget files!")
